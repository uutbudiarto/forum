...
<div class="card mb-3 border-0 rounded-0">
  <div class="row no-gutters">
    <div class="col-md-4">
      <img src="<?=base_url('assets/img/profile/').$emp_det->image; ?>" class="card-img" alt="IMAGE">
    </div>
    <div class="col-md-8">
      <div class="card-body">
        ...
        <p class="card-text"><i class="fas fa-fw fa-user-tie"></i>
          <?=$emp_det->position_name; ?>
        </p>
        <?php if($this->session->userdata('role_id') != 3) : ?>
        <a href="#" class="btn btn-sm btn-dark rounded-0 shadow-sm">
          <i class="fas fa-file-signature"></i> Lihat Laporan
        </a>
        <a href="#" class="btn btn-sm btn-gold rounded-0 shadow-sm">
